...
print(post("http://127.0.0.1:5000/api/v2/users", json={"username": "test1", "password": "123"}).json())  # username taken
...
print(put("http://127.0.0.1:5000/api/v2/notes/1", json={"username": "test1", "password": "123456", "content": "test_note_edit", "private": True}).json())  # edit note
